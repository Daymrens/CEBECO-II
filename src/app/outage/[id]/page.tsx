  ...
  return (
    <div className="flex min-h-svh flex-col bg-zinc-50">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8">
        ...
        {notFound && (
          <div className="mt-10 rounded-2xl border border-dashed border-zinc-300 px-4 py-14 text-center">
        ...
        {outage && (
          <article className="mt-6">
            ...
            <dl className="mt-6 space-y-3 rounded-2xl border border-zinc-200 bg-white p-6 text-sm">
              <div className="flex gap-3">
                <dt className="w-28 shrink-0 font-medium text-zinc-400">
                  Municipality
                </dt>
                <dd className=" text-zinc-900">{outage.municipality}</dd>
              </div>
              <div className="flex gap-3">
                <dt className="w-28 shrink-0 font-medium text-zinc-400">Date</dt>
                <dd className=" text-zinc-900">{formatDate(outage.date)}</dd>
              </div>
              <div className="flex gap-3">
                <dt className="w-28 shrink-0 font-medium text-zinc-400">Time</dt>
              ...
              <div className="flex gap-3">
                ...
                <dd className=" text-zinc-900">{outage.barangays.join(", ")}</dd>
              </div>
              {outage.sitio_notes && (
                <div className="flex gap-3">
                  <dt className="w-28 shrink-0 font-medium text-zinc-400">
                  ...
                  <dd className=" text-zinc-900">{outage.sitio_notes}</dd>
                </div>
              )}
              {outage.reason && (
                <div className="flex gap-3">
                  ...
                  <dd className=" text-zinc-900">{outage.reason}</dd>
                </div>
              )}
            </dl>
