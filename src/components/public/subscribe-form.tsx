...
const inputClass =
  "w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
...
export function SubscribeForm({ barangay }: { barangay?: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <div>
        <label htmlFor="subscribe-email" className="mb-1 block text-sm font-medium text-gray-700">
          Email address
        </label>
        <input
          id="subscribe-email"
      ...
      <div>
        <label htmlFor="subscribe-barangay" className="mb-1 block text-sm font-medium text-gray-700">
          Barangay
        </label>
        <select
      ...
      <div>
        <label htmlFor="subscribe-sitio" className="mb-1 block text-sm font-medium text-gray-700">
          Sitio <span className="font-normal text-gray-400">(optional)</span>
        </label>
        <input
          id="subscribe-sitio"
          value={sitio}
